---
title: "AI 보이스 만들기: ElevenLabs로 레퍼런스 잡고 로컬 대체제까지 보기"
description: "영상 내레이션용 AI 보이스를 만들 때 ElevenLabs Voice Design으로 목소리 정체성을 잡고, 약관과 비용 리스크를 확인하면서 로컬 대체제까지 검토한 작업 메모."
slug: "ai-voice-making-2026"
