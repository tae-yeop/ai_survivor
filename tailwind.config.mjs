  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'mast':       ['clamp(1.95rem, 4.5vw, 3.4rem)', { lineHeight: '1.08', letterSpacing: '-0.025em', fontWeight: '700' }],
        'display-lg': ['clamp(1.75rem, 3.5vw, 2.7rem)', { lineHeight: '1.12', letterSpacing: '-0.022em', fontWeight: '700' }],
        'display':    ['clamp(1.55rem, 2.6vw, 2.15rem)', { lineHeight: '1.18', letterSpacing: '-0.02em',  fontWeight: '700' }],
      },
      spacing: {
        '18': '4.5rem',
        '22': '5.5rem',
