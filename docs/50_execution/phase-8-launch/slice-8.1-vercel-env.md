...
Phase: 8 — Launch
Status: Partial - Vercel app live verified, custom-domain env remains
...
- [ ] Audit full Preview / Production env separation (`ADS_ENABLED`, analytics/search verification values)
- [x] Set `NEXT_PUBLIC_SITE_URL` to the real Vercel production URL before buying a domain
...
- canonical/sitemap/RSS points at the current production URL or operating domain. Verified on 2026-05-09 for the Vercel production URL.
