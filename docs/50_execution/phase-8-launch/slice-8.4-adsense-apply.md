...
- [ ] `/resources` 또는 `/tool-stack` 페이지 기획
- [ ] `AffiliateLink`, `ProductCard`, `DisclosureBox` 컴포넌트 필요 여부 결정
- [ ] Coupang Partners / Amazon Associates / AI 도구 referral 후보별 필수 고지 문구 확인
- [ ] 컨설팅/워크숍 문의 CTA를 Contact 흐름으로 연결
