...
일레븐랩스 이용
문제는 재학습은 규정상 금지되어 있음
콜랩을 T4가 더이상 계속 무료가 아님
하다보면 제한생기고 안됨.

결국 돈 낼수 밖에 없음
한달 바짝 쓸거면 일레븐랩스 쓰는게 맞는거 같고

TTS로 대략적으로 만들 수 있는게 30분정도라서
영상을 많이 만들려면 크리에이터를 쓰고 매달 22달러 계속 내야



| 요금제      |           월 가격 | 월 크레딧 |         대략 음성 생성량 |
| -------- | -------------: | ----: | ----------------: |
| Free     |             $0 |   10k |             약 10분 |
| Starter  |           $6/월 |   30k |             약 30분 |
| Creator  | $22/월, 첫 달 $11 |  121k |     약 121분, 약 2시간 |
| Pro      |          $99/월 |  600k |    약 600분, 약 10시간 |
| Scale    |         $299/월 |  1.8M |  약 1,800분, 약 30시간 |
| Business |         $990/월 |    6M | 약 6,000분, 약 100시간 |


콜랩

| 선택지                 |       가격 |                      제공량 | 대략 GPU 사용량                                |
| ------------------- | -------: | -----------------------: | ----------------------------------------- |
| Colab Pay As You Go |    $9.99 |        100 Compute Units | T4 약 84시간, L4 약 58시간, A100 40GB 약 18.5시간  |
| Colab Pro           |  $9.99/월 |      100 Compute Units/월 | 위와 거의 동일                                  |
| Colab Pro+          | $49.99/월 | 공식 페이지 스니펫 기준 월 총 600 CU | T4 약 500시간, L4 약 350시간, A100 40GB 약 110시간 |


위 GPU 시간은 Google이 공식 보장한 수치가 아니라, 2026년 3월 실측 기준입니다. 해당 실측에서는 100 CU로 T4 84시간, L4 58시간, A100 40GB 18.5시간, A100 80GB 13.3시간 정도였습니다. 지역/시간/수요에 따라 달라질 수 있습니다

반면 ElevenLabs는 Starter 30k 크레딧, Creator 121k 크레딧, Pro 600k 크레딧 같은 식이고, Multilingual v1/v2는 보통 1글자 = 1크레딧이라 대략 “1,000자 ≈ 1분” 감각으로 보면 됩니다. 즉 Creator도 약 2시간 안팎이라, 대량 생성이면 Colab 쪽 단가가 훨씬 낮습니다.
